...
* Supported file formats: JPEG, PNG, PDF, BMP and TIFF. Text-embedded PDFs are best because there's no possibility of error in character extraction and location.
